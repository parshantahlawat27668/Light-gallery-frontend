  ...
  return (
    ...
    <form className={styles.form} onSubmit={loginHandler}>
      ...
      {loginWith==="phone"?<div className={styles.groupField}>
        ...
        <input required type='tel' id='phone' name='phone' placeholder='Enter your phone no.' value="7478596544" readOnly></input>
      ...
      <input required type='password' id='password' name='password' placeholder='Minimum 6 characters' value="strongPassword" readOnly></input>
      </div>
      <button type='submit' className={styles.btn}>Login</button>
      <p>Don't have an account? <Link to="/auth/register" style={{color:"#C7AE6A"}}>register</Link></p>
    </form>
    </div>
  )
}
